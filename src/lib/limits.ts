export const LIMITS = {
  ...
  PROJECT_THUMBNAIL_IMAGE: 500,
  PROJECT_THUMBNAIL_VIDEO: 500,
  PROJECT_THUMBNAIL_TYPE: 10,
  PROJECT_THUMBNAIL_ALT: 200,
  PROJECT_CHALLENGE: 5000,
  PROJECT_APPROACH: 5000,
  PROJECT_OUTCOME: 5000,
  PROJECT_TESTIMONIAL: 2000,

  // Client
  CLIENT_REPRESENTATIVE_NAME: 100,
  CLIENT_REPRESENTATIVE_DESIGNATION: 100,
