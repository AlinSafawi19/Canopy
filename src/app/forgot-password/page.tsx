    ...
    <div className="min-h-screen bg-slate-50 mk-grid flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-5 sm:mb-8">
          ...
          <p className="text-slate-500 text-xs sm:text-sm mt-1">Reset your password</p>
        </div>

        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-5 sm:p-8">
          <h2 className="text-base sm:text-lg font-semibold text-slate-900 mb-4 sm:mb-5">Forgot password?</h2>
          <ForgotForm />
        </div>
