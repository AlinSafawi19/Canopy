...
const PATH = "/admin/archive/entries";
...
export default async function AdminArchiveEntriesPage({
  searchParams,
}: {
              ...
              return (
                <TableRow key={entry.id}>
                  ...
                  <TableCell className="max-w-[180px]">
                    <Link
                      href={`/admin/projects/${entry.category.project.id}`}
                  ...
                  <TableCell className="max-w-[180px]">
                    <Link
                      href={`/admin/projects/${entry.category.project.id}/categories/${entry.category.id}`}
                      className="block truncate text-slate-700 hover:text-indigo-600 transition-colors"
                    >
                      {entry.category.name}
                    </Link>
