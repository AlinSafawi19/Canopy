      ...
      <Modal ref={modalRef} open={open} onClose={() => { setOpen(false); setTouched(false); }} title="Create Category" size="sm" isDirty={touched} busy={loading}
        footer={
          <div className="flex justify-end gap-3">
            ...
            <Button type="submit" form="create-category-form" loading={loading}>Create</Button>
          </div>
        }
      >
        <form id="create-category-form" onSubmit={handleSubmit} className="space-y-4" onInput={() => setTouched(true)}>
