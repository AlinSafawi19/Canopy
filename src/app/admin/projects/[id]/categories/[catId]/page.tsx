                  ...
                  <thead>
                    <tr className="bg-slate-50 border-b border-slate-200">
                      ...
                      {fields.map((f) => (
                        <th
                          key={f.name}
                          className="px-4 py-2.5 text-left font-medium text-slate-700 border-r border-slate-200 min-w-[160px] whitespace-nowrap"
                        >
                        ...
                        >
                          ...
                          {fields.map((f) => {
                            ...
                            return (
                              <td
                                key={f.name}
                                className="px-4 py-2.5 border-r border-slate-100 max-w-[240px]"
                              >
                                {display ? (
                          ...
                          <td className="px-4 py-2.5 border-r border-slate-100">
                            <EntryStatusBadge entry={entry} categoryId={catId} projectId={id} />
                          </td>
