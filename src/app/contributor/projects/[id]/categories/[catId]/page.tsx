                ...
                <table className="w-full text-sm border-collapse">
                  <thead>
                    <tr className="bg-slate-50 border-b border-slate-200">
                      ...
                      {(permissions.canEditEntries || permissions.canDeleteEntries) && (
                  ...
                  <tbody>
                    {entries.length === 0 ? (
                      <tr>
                        <td className="px-4 py-8 text-center text-slate-400 text-sm" colSpan={fields.length + (permissions.canEditEntries || permissions.canDeleteEntries ? 3 : 2)}>
