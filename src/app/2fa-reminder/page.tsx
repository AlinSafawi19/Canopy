    ...
    <div className="min-h-screen bg-slate-50 mk-grid flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-5 sm:mb-8">
          ...
          <p className="text-slate-500 text-xs sm:text-sm mt-1">Account security</p>
        </div>

        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-5 sm:p-8">
          <div className="flex justify-center mb-4 sm:mb-5">
            <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-amber-50 flex items-center justify-center">
              <ShieldCheck size={24} className="text-amber-500 sm:hidden" />
              <ShieldCheck size={32} className="text-amber-500 hidden sm:block" />
            </div>
          </div>

          <h2 className="text-base sm:text-xl font-semibold text-slate-900 text-center mb-2">
            Your account needs one more layer
          </h2>
          <p className="text-slate-500 text-xs sm:text-sm text-center mb-1">
            Two-factor authentication (2FA) means every login requires both your password <em>and</em> a short code from your phone.
          </p>
          <p className="text-slate-400 text-xs text-center mb-4 sm:mb-6">
            Most account breaches happen because of stolen or reused passwords. 2FA makes a stolen password useless on its own.
          </p>

          <div className="space-y-3 mb-4 sm:mb-6 bg-slate-50 border border-slate-100 rounded-xl p-3 sm:p-4">
